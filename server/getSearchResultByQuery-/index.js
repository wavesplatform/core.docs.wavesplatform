...
const VueForServer = require(path.join(global.coreRootPath, 'utils/vueForServer'));
const {PromiseWithOutsideResolve} = require(path.join(global.coreRootPath, 'utils'));
...
module.exports = function(vuepressDestPath) {

    return new VueForServer({
        data() {
            return {
                vuepressDestPath,
                createdPromise: new PromiseWithOutsideResolve(),
            }
        },
        ...
        async created() {
            ...
            this.searchMiddleware =  (searchQueryString, searchLocale) => {
